...
<input type="text" class="form-control" name="name" id="name" placeholder="Your Name" required>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="more-info">
                      ...
                      <ul class="list-ico">
                        <li><span class="bi bi-geo-alt"></span> NO 7 Rahama Plaza, KM 8 Okene-Lokoja Expressway, Kogi State</li>
                        <li><span class="bi bi-phone"></span> (234) 379-45052</li>
                        <li><span class="bi bi-envelope"></span> jintano4real007@gmail.com</li>
                      </ul>
                    </div>
                    <div class="socials">
                      <ul>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box">
            <p class="copyright">&copy; Copyright <strong>Goodmanfolio</strong>. All Rights Reserved</p>
            <div class="credits">
              <!--
